...
def setup_arg_parser():
    ...
    arg_parser.add_argument("--sample-image", default=None, type=str, help="sample image for input")
    arg_parser.add_argument("--run-eval", action="store_true")
    arg_parser.add_argument("--output", help="output directory for the converted model")
    arg_parser.add_argument(
        "opts",
