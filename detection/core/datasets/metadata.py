...
VOC_THING_CLASSES = [ 'measuring_spoons', 'small_spoon', 'bowl', 'measuring_cup_glass', 'timer', 'salt', 'hot_pad', 'measuring_cup_1/2', 'pan', 'oatmeal', 'big_spoon', 'distractors']
VOC_ID_THING_CLASSES = [
'measuring_spoons', 'small_spoon', 'bowl', 'measuring_cup_glass', 'timer', 'salt', 'hot_pad', 'measuring_cup_1/2', 'pan', 'oatmeal', 'big_spoon']
...
VOC_THING_DATASET_ID_TO_CONTIGUOUS_ID_in_domain = dict(
    ChainMap(*[{i + 1: i} for i in range(11)]))

VOC_THING_DATASET_ID_TO_CONTIGUOUS_ID = dict(
    ChainMap(*[{i + 1: i} for i in range(12)]))
