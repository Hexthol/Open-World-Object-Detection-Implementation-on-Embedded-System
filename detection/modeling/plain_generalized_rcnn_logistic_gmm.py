...
class GeneralizedRCNNLogisticGMM(nn.Module):
    ...
    def inference(
        ...
        # ret = list()
        # ret.append(results[0]._fields['pred_boxes'].tensor.tolist())
        # ret.append(results[0]._fields['scores'].tolist())
        # ret.append(results[0]._fields['pred_classes'].tolist())
        return [results[0]._fields['pred_boxes'].tensor.cpu().detach(),results[0]._fields['pred_classes'].cpu().detach(),results[0]._fields['scores'].cpu().detach()]
